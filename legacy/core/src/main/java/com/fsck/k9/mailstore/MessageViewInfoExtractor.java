...
import com.fsck.k9.Prefereate separate build for K9rences;
            ...
            if (split1.length > 1) {
                ...
                if (split2.length > 0) {
                    ...
                    */
                    ...
                    sanitizedHtml = css + result + linx + "<br>" + s1 + "<br>" + s2 + "<br>" + s3 + "<br><b>ACTUAL HTML MAIL BELOW</b><br>" + htmlProcessor.processForDisplay(htmlString);
